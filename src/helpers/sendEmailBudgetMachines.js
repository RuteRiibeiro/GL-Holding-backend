...
module.exports = ({ name, companyName, email, phoneNumber, comments, time, equipment }, cb) => {
  const messageEmail = `
    ...
    <br /><hr />
    <br />
    <h2 style="text-align: center;">DHL locação de equipamentos</h2>
    <br />
    <p>Nome: ${name}</p>
